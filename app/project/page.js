...
const Projects = () => {
    return (
        <> 
        <h2 className=" mb-4 mt-9 text-5xl tracking-tight font-extrabold text-center text-gray-500 dark:text-slate-500">Personal Projects </h2>
        ...
        <section className='flex justify-center gap-28 max-sm:items-center  max-sm:flex-col'>
            ...
            transition={{ duration: 0.4 }} 
                className=" hover:bg-slate-200 shadow-2xl border border-1 border-solid border-black max-sm:mb-5 max-sm:rounded-md  block max-w-[18rem] rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-blue-300 ">
            ...
            className="hover:bg-slate-200  border border-1 border-solid border-black max-sm:mb-5 max-sm:rounded-md  block max-w-[18rem] rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-blue-300 ">
