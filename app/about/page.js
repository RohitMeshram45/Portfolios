      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col justify-center items-center">
        ...
        <motion.div whileHover={{ scale: [null, 1, 1.02] }}
          ...
          <div className='flex justify-center'>
            <img className="hover:shadow-2xl  max-sm:h-[60px] object-contain rounded h-[70px] p-3 bg-contain sm:h-[100px]" src='React.png' />
            <img className="hover:shadow-2xl  max-sm:h-[60px] object-contain rounded h-[70px] p-3 bg-contain sm:h-[100px]" src='tailwind.png' />
            <img className="hover:shadow-2xl  max-sm:h-[60px] object-contain rounded h-[70px] p-3 bg-contain sm:h-[100px]" src='javascript.png' />
          </div> 
          <div className='flex justify-center'>
            <img className="hover:shadow-2xl  max-sm:h-[60px] object-contain rounded h-[70px] p-3 bg-contain sm:h-[100px]" src='html.png' />
            <img className="hover:shadow-2xl  max-sm:h-[60px] object-contain rounded h-[70px] p-3 bg-contain sm:h-[100px]" src='css.png' />
            <img className="hover:shadow-2xl  max-sm:h-[60px] object-contain rounded h-[70px] p-3 bg-contain sm:h-[100px]" src='nodejs.png' />
          </div>
          <div className='flex justify-center'>
            <img className="hover:shadow-2xl  max-sm:h-[60px] object-contain rounded h-[70px] p-3 bg-contain sm:h-[100px]" src='github.png' />
            <img className="hover:shadow-2xl  max-sm:h-[60px] object-contain rounded h-[70px] p-3 bg-contain sm:h-[100px]" src='vscode.png' />
            <img className="hover:shadow-2xl  max-sm:h-[60px] object-contain rounded h-[70px] p-3 bg-contain sm:h-[100px]" src='LeetCode.png' />
          </div>
        </motion.div>
        <motion.div whileHover={{ scale: [null, 1, 1.02] }}
